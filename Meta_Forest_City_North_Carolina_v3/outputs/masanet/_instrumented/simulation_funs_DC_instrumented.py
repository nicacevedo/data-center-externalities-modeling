# Runtime diagnostic copy under v3 only.
...
COP_gp = pickle.load(open(r'/home/nacevedo/RA/data-center-externalities-modeling/other_sources/masanet/external/Data-Center-Water-footprint/COP_2.pkl', 'rb'))
# for DX system
COP_DX_gp = pickle.load(open(r'/home/nacevedo/RA/data-center-externalities-modeling/other_sources/masanet/external/Data-Center-Water-footprint/COP_DX.pkl', 'rb'))
# for air-cooled chiller
COP_air_gp = pickle.load(open(r'/home/nacevedo/RA/data-center-externalities-modeling/other_sources/masanet/external/Data-Center-Water-footprint/COP_AC.pkl', 'rb'))
