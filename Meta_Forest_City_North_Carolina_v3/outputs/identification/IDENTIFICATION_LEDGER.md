...
Do not choose facility Delta-T to match annual water. CFM identifies airflow only; SAT/RAT supplies an air-side temperature difference, and a matched heat/load boundary is required to close `Q = m_dot cp DeltaT`.

| quantity | identification | evidence_class | notes |
| --- | --- | --- | --- |
