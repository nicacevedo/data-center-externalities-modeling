...
The command uses existing processed data only, does not download, and fails if prerequisites are missing. It is deterministic (figure 6 week selection is a documented argmax; seed {RNG_SEED} is recorded even though this report draws no new stochastic ensemble). This generated report corresponds to freeze **Prineville Public-Data Baseline v1**.
"""
