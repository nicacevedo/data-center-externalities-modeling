...
|---|---|
| **Observed / reported** | Annual Meta electricity, withdrawal, location Scope 2; City-metered Facebook Data Center service water (customer-service boundary); KS39/KRDM weather; OWRD City pumping and Vitesse/Facebook POD use (each at its own accounting boundary); GWIS measured well water levels; EIA-930 PACW hourly; FERC PacifiCorp-West monthly; FERC East+West combined hourly; DEQ backup hours where extractable; CAMPD CEMS; EIA-860/923 where reported |
