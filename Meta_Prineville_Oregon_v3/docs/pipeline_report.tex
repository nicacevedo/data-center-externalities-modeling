...
% ================================================================
\newcommand{\BaselineName}{Prineville Public-Data Baseline v1}
\newcommand{\BaselineCommit}{\texttt{ac0adf6}}
\newcommand{\SourceCount}{44}
\newcommand{\QuantityCount}{76}
\newcommand{\ModelCount}{18}
...
Subannual campus water & \(W_t\) & \Scenario / weak prediction & No monthly campus meter; current allocations/predictions are not telemetry. \\
...
Cooling \(\rightarrow\) campus water & monthly campus water, consumption vs withdrawal, discharge/return, cooling-loop operation, source/reuse shares & Reliable subannual water prediction and source-resolved accounting. \\
...
\item reconstructing actual monthly campus water without a meter/stronger model;
...
\item Should the next identification effort prioritize groundwater response, or is there a higher-value missing relationship (for example monthly campus water/source shares)?
...
City of Prineville & Public-records request mechanism & \url{https://www.cityofprineville.com/1294/Public-Records} & current request mechanism &  & documented route for monthly Meta water, discharge, ASR/head (not acquired) & No monthly Meta water/discharge/ASR operational series is in the repository.\\
