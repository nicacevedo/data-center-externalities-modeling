...
Subannual campus water & \(W_t\) & Mixed: City-service observed 2012--2026-07; campus total unresolved & City meters observe Facebook Data Center WATER-COMM + ADD'L WATER, not Meta campus-total withdrawal. \\
...
5. Model / infer & Infer only quantities that are not directly observed. & Hourly IT load and all-source monthly campus withdrawal still require reconstruction. City customer-service water is observed through 2026-07. \\
...
City customer-service meters & month (observed 2012--2026-07; 2012 and 2026 partial) \\
...
Water footprint: Li et al.; Gupta et al.; Han et al. & Direct vs indirect water; temporal water signals; peak public-water capacity & Annual direct water + observed monthly City-service component + partial regional generator-water diagnostics & All-source monthly campus withdrawal, source shares, withdrawal/consumption/discharge, peak delivery. \\
...
Not yet identified & hourly Meta IT; all-source monthly campus withdrawal / complete campus water balance; exact source shares; pumping-to-head causal response; aquifer dynamics; exact serving generators/marginal impacts; costs/optimization & Requires new identification or data before strong claims/optimization. \\
\bottomrule
\end{tabularx}
...
City of Prineville & Facebook utility-meter package (2026 delivery) & local \texttt{data/raw/city\_prineville\_public\_records\_2026/} & 2012-12 through 2026-07 (2012 and 2026 partial) & \texttt{src/prepare\_city\_prineville\_utility.py} & observed City customer-service WATER-COMM + ADD'L WATER; not Meta campus-total withdrawal & SWR physical direction unknown; WELL METER FOR SEW / bulk / Trailer City / Warehouse remain unresolved. Extra unnumbered CSV is a duplicate of (1).csv.\\
...
OWRD external water-evidence comparison & validation/QA & Aligns the modeled monthly campus-water proxy (unresolved all-source campus withdrawal) with City production and direct POD without using them as calibration targets or summing boundaries. & no\\
City-service climatology / seasonal persistence & forecastable baseline & Expanding-window month-of-year mean or previous-year same month for observed City-service water. Common-support ranking is primary. & yes (retrospective/exploratory)\\
City-service electricity/weather models & contemporaneous explanatory & Annual electricity scale and gray-box evaporation use target-year electricity and/or realized target-month weather. Not strictly prospective. & yes (retrospective/exploratory)\\
