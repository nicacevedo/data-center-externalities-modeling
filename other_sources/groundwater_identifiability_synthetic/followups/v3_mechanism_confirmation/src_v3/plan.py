...
from .design import RegimeSpec, gate_cells, reporting_cells, resolve_regime, v3_all_cells
...
def all_cells(design: dict[str, Any]) -> dict[str, RegimeSpec]:
    """V3 frozen 21-cell plan. V2 grids/curves are empty in design_v3.yaml."""
